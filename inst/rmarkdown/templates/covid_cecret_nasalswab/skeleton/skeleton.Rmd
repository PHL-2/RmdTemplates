...
if(!(check_fasta == 1 & check_rerun == 2)) {
  stop(simpleError("Please upload the concatenated fasta file to https://clades.nextstrain.org first and check the quality before continuing to submit data"))
}
