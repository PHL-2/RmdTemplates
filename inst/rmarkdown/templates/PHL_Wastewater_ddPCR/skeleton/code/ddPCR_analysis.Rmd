...
if (variance_test | signal_check) {
  if (!all_var_check) {
    ...
    if (signal_check) {
      print(paste("Detected wells with high variance:", paste(wellsToRemove2, collapse =", "), collapse = " "))
    } 
    if(variance_test) {
      print(paste("Detected wells with no signal:", paste(wellsToRemove1, collapse =", "), collapse = " "))
    }
...
if (variance_test | signal_check) {
  if (!all_var_check) {
    ...
    if (signal_check) {
      print("Detected wells with no signal")
    } 
    if(variance_test) {
      print("Detected wells with high variation")
    }
    print(paste("Wells", paste(wellsToRemove, collapse = ", "), "have been removed", collapse = ""))
  }
...
## Wastewater signal with MHV removed
