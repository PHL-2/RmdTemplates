...
unaccounted_sample_types <- unique(s_meta$sample_type)[!unique(s_meta$sample_type) %in% c(ctrl_fct_lvls)]

sample_type_lvls <- c(NA, "Reference", "Unassigned reads",
                      ctrl_fct_lvls, unaccounted_sample_types, paste0(unaccounted_sample_types, " - Poor"))
...
sample_type_color_select <- c(15, 19, 16, 13, 2, 1, 4)
