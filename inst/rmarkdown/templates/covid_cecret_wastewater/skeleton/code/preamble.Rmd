...
if(nrow(seqsender) != 0) {
  ...
  seqsender <- seqsender %>%
    rename(sequence_name = "sample_id",
           ...
           `bs16-ww_surv_system_sample_id` = "bs-ww_surv_system_sample_id") %>%
    mutate(collection_date = case_when(!(is.na(sample_collect_date) |
           ...
           `gs-covv_subm_sample_id` = `bs16-ww_surv_system_sample_id`,
           ...
           `bs8-isolate` = uniq_sample_name,
           `bs9-specimen_processing_id` = sample_name,
           #bs10-specimen_processing
           #bs11-specimen_processing_details
           #bs12-concentration_method
           #bs13-extraction_method
           #bs14-extraction_control
           #bs15-project_name
           #bs16-ww_surv_system_sample_id #this column is defined above, not in metadata sheet
           #bs17-ww_sample_site
           #bs18-ww_sample_matrix
           #bs19-ww_sample_type
           #bs20-ww_sample_duration
           #bs21-ww_surv_jurisdiction
           `bs22-collection_site_id` = wwtp_name,
