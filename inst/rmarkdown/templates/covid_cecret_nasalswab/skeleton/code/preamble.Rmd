...
ec2_upload_fp <- paste0("~/seqsender_upload/", sequencing_date, "/")
...
seqsender <- s_toPlot %>%
  ...
  mutate(orig_lab_address = case_when(orig_lab == "Philadelphia Department of Public Health" ~ "1930 South Broad Street Suite 37, Philadelphia, PA 19145 USA",
                                      ...
                                      TRUE ~ "Unknown")) %>%
  mutate(sra_file_path_1 = paste0(ec2_upload_fp, sample_id, "_filtered_R1.fastq.gz"),
         sra_file_path_2 = paste0(ec2_upload_fp, sample_id, "_filtered_R2.fastq.gz")) %>%
