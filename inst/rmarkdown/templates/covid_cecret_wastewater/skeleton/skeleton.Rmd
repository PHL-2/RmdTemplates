...
dir.create(file.path(copy_to, project_name), recursive = TRUE, showWarnings = FALSE)
...
if(!file.copy(here("upload", "epi"), file.path(copy_to, project_name), recursive = TRUE, overwrite = TRUE)) {
  stop(paste("Could not copy file to", file.path(copy_to, project_name),
