...
epi_report_fp <- here("upload", "epi", paste(project_name, "PHL2_sequencing_results.csv", sep = "_"))
seqsender_meta_fp <- here("upload", "seqsender", paste(project_name, "PHL2_seqsender_upload_orig.csv", sep = "_"))
lims_import_fp <- here("upload", "lims", paste(project_name, "PHL2_NS_LIMS_import.csv", sep = "_"))
