...
seqsender <- s_toPlot %>%
  ...
  mutate(collection_date = case_when(!(is.na(sample_collection_date) |
         ...
         `bs6-host_age` = `gs-covv_patient_age`,
         ...
         `sra11-design_description` = paste0("Viral sequencing was performed following a tiling amplicon strategy using the ARTIC Network Protocol ", artic_primer_scheme,
