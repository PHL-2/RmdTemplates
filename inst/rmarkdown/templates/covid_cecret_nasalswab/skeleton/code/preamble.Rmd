...
seqsender <- s_toPlot %>%
  ...
  mutate(collection_date = case_when(!(is.na(sample_collection_date) |
         ...
         `sra10-design_description` = paste0("Genomic reads were enriched using a tiled amplicon strategy with the ARTIC Network Protocol ", artic_primer_scheme,
         ...
         `sra13-file_1` = paste0(sequence_name, "_S", sample_number, "_filtered_R1.fastq.gz"),
         `sra14-file_2` = paste0(sequence_name, "_S", sample_number, "_filtered_R2.fastq.gz"),
         #GenBank fields
