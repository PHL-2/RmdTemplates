...
s_toPlot %>%
  ...
  ungroup() %>%
  select(ww_group, sample_collect_date, Nextclade_pango, nextclade_clade_who, all_samples_n) %>%
  group_by(sample_collect_date, ww_group, nextclade_clade_who, Nextclade_pango) %>%
  ...
  ungroup() %>%
  arrange(sample_collect_date, -variant_percentages) %>%
  select(-variant_percentages) %>%
  unique() %>%
  rename(`Received date` = "sample_collect_date", `Samples and Sites` = "ww_group", `WHO` = "nextclade_clade_who", `Variant` = "Nextclade_pango", `Variant percentage` = "variant_percentages_text") %>%
  { if(use_kable)
