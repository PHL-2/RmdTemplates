...
# aws s3 cp s3://COVIDSeq-output/[sequencing_date]_COVIDSeq/ . \
#   --recursive \
#   --exclude "*" \
...
ann_geom_values[["sample_type_colors"]] <- setNames(pal_d3("category20")(20)[c(15, 19, 16, 13, 2, 1, 4, 10, 7, 8)], lvls)

#make the controls and unassigned reads into triangle and diamond shapes
ann_geom_values[["sample_type_shapes"]] <- setNames(c(8, 24, 13, 25, 23,
                                                      21, 22, 21, 22,
                                                    c(9:14)[1:(length(lvls)-9)]), lvls)
