...
warning(simpleWarning(
  paste("\n Before continuing, upload", basename(consensus_fasta_fp), "in", here("upload", "fasta/"),
        ...
        "If any sequences are low quality, delete the sample FASTA file from processed_cecret/ivar_consensus\n",
        "Rerun this script starting with create_concat_consensus to recreate the new merged FASTA file for submission")))
Sys.sleep(20)
...
seqsender %>%
  ...
  merge(gisaid_accessions, by = "bs-gisaid_virus_name", all.x = TRUE) %>%
