...
```{r aligned fastq and depth files, eval = import_data}

#copy aligned fastq files for SRA submission
filtered_fqs <- list.files(here("data", "processed_cecret", "filter"), pattern = ".R[12].fastq.gz", recursive = TRUE, full.names = TRUE)
