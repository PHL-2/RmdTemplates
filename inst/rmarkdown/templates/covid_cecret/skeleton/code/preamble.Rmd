...
#define all other sample types
typical_sample_types <- c("Nasal swab", "Nasal swab - Poor", "Wastewater", "Wastewater - Poor")

unaccounted_sample_types <- unique(s_meta$sample_type)[!unique(s_meta$sample_type) %in% c(ctrl_fct_lvls, typical_sample_types)]

sample_type_lvls <- c("Reference", "Unassigned reads",
                      ctrl_fct_lvls, typical_sample_types, unaccounted_sample_types, NA)
...
#different alpha values based on sample numbers
ann_geom_values[["alpha"]] <- setNames(c(1, 1, 0.4, 1, 0.4, 1, rep(0.2, length(sample_type_lvls)-6)), sample_type_lvls)
