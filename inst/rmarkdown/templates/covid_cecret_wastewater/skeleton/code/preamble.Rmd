  ...
  data_upload_all %>%
    ...
    mutate(description = paste(sample_description, design_description),
          #need to fill these in
           ww_surv_target_1_known_present = ifelse(has_N2,
                                                   ifelse(N2_present, "Yes", "No"),
                                                   ""),
           ww_surv_target_1_conc = ifelse(has_N2, `N2_gc/L`, ""), #this is the ddPCR transformed unit
           ww_surv_target_2_known_present = ifelse(has_N2,
                                                   ifelse(N2_present, "Yes", "No"),
                                                   ""),
           ww_surv_target_2_conc = ifelse(has_N2, `E_gc/L`, ""),
           gisaid_accession = "") %>%
