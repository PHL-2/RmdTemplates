...
freyja_lineages <- s %>%
  select(sample_id, sample_name, sample_group, ww_group, !!date_col,
...
s_merged <- s %>%
  ...
  select(sequencing_date,
         ...
         merged_freyja_summarized = "freyja_summarized",
         merged_freyja_lineages = "freyja_lineages",
         merged_freyja_abundances = "freyja_abundances",
         merged_A_detected)

lims_import <- s %>%
  filter(!grepl("Merged|Undetermined", sample_id)) %>%
  left_join(s_merged, by = c("sequencing_date", "uniq_sample_name")) %>%
